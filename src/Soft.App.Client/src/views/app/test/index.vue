<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="用户名" prop="testUser">
        <el-input
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户Id" align="center" prop="testId" />
      <el-table-column label="用户名" align="center" prop="testUser" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户名" prop="testUser">
          <el-input v-model="form.testUser" placeholder="请输入用户名" />
        </el-form-item>
      </el-form>
...
<script>
import { listTest, getTest, delTest, addTest, updateTest, exportTest } from "@/api/app/test";
